...
#define DELAY(delay, phase, mem, mem_size) (mem)[(((unsigned)(phase) - ((unsigned)(delay) - 1U)) % (mem_size))]
...
inline static int32_t pole_24r25_3f49(int32_t input, int32_t mem[2], uint8_t *phase)
{
    ...
    int64_t t1     = -(int64_t)a1 * (int64_t)DELAY(1, *phase, mem, 2);
    int64_t t2     = -(int64_t)a2 * (int64_t)DELAY(2, *phase, mem, 2);
    int32_t output = ((t1 + t2) >> 30) + input;
